...
template <class T>
void AudioFile<T>::summary() const
{
    std::cout << "|======================================|" << std::endl;
    //std::cout << "Num Channels: " << getNumChannels() << std::endl;
    std::cout << "Total Samples: \t" << getNumSamplesPerChannel() << std::endl;
    std::cout << "Sample Rate: \t" << sampleRate << std::endl;
    std::cout << "Bit Depth: \t" << bitDepth << std::endl;
    std::cout << "Seconds: \t" << getLengthInSeconds() << std::endl;
    std::cout << "isMono?: \t" << isMono() << std::endl;
    std::cout << "|======================================|" << std::endl;
}
